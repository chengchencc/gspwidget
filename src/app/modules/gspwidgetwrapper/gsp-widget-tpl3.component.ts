...
@Component({
    selector: 'gsp-widget-tpl3',
    template:`   
    <gsp-widget [col]="1" [row]="1" [bodyStyle]="{'border-radius':'10px'}" [wgStyle]="{'border-radius':'5px'}" [title]="'My Notifications'" >
...
export class GspWidgetTpl3Component implements OnInit {
    constructor() { }
